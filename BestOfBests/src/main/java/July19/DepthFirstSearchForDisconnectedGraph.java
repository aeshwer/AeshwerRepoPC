...
public class DepthFirstSearchForDisconnectedGraph {

	private int vertices; // No. of vertices
	private LinkedList<Integer> adj[]; // Adjacency Lists

	// Constructor
	public DepthFirstSearchForDisconnectedGraph(int vertices) {
	...
	public static void main(String[] args) {
		DepthFirstSearchForDisconnectedGraph g = new DepthFirstSearchForDisconnectedGraph(4);
