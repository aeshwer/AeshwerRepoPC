...
public class TradeDataSetGenerator {
	...
	public static List<Trade> retriveDummyTradesFeeder()
	{
		...
		dummyTradeList.add(new Trade(LocalDate.of(2017, Month.FEBRUARY, 10),"Sell",102d,52d,new Delivery(LocalDate.of(2017, Month.FEBRUARY, 19),LocalDate.of(2018, Month.JUNE, 29),"IMPS")));
