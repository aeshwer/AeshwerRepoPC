...
public class MergeTwoListResultReversesList {
	...
	Node sortedmerge(Node node1, Node node2) {
		...
		while (node1 != null && node2 != null) {
			...
			if (node1.data <= node2.data) {
				...
				// we are here also deleting the added element from original list to reduce its length
	...
	public static void main(String[] args) {
		MergeTwoListResultReversesList list = new MergeTwoListResultReversesList();
		Node result = null;
		...
		list.a.next.next.next = new Node(70);
