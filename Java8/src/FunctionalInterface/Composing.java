...
public class Composing {
	public static void main(String[] args) {
		...
		for (String doc : documents) {
			...
			// see how we can use the Bi-function
			...
			if (biFunction.apply(doc, "stream")) {
				...
				// Observe here how we can compose 2 functions using the 'andThen' API. so first the htmlCleaner is applied , then stopwordRemover is applied
