...
public class MergeKSortedArray {
	...
	private static List<Integer> mergeSortedArrays(List<List<Integer>> sortedArrays) {
		...
		// add iterator to the iterator list
		 ...
		 */
		Queue<ArrayEntry> minHeap = new PriorityQueue<>(((int) sortedArrays.size()), new Comparator<ArrayEntry>() {
			@Override
	...
	public static void main(String[] args) {
		List<Integer> arrayList1 = new ArrayList<>(Arrays.asList(1,4,7,8,9));
		List<Integer> arrayList2 =new ArrayList<>( Arrays.asList(2,12));
		List<Integer> arrayList3 = new ArrayList<>(Arrays.asList(3,7,14));

		List<List<Integer>> sortedArrays = new ArrayList<>();
		sortedArrays.add(arrayList1);
		sortedArrays.add(arrayList2);
		sortedArrays.add(arrayList3);

		List<Integer> result = mergeSortedArrays(sortedArrays);
